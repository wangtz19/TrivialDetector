...
editcap -r dataset/HOIC.pcap attack_set/HOIC_small.pcapng 1-1000000
editcap -r dataset/LDoS.pcap attack_set/LDoS_small.pcapng 1-1000000
editcap -r dataset/LOIC_UDP.pcap attack_set/LOIC_UDP_small.pcapng 1-1000000
editcap -r dataset/SYNDoS.pcap attack_set/LDoS_small.pcapng 1-1000000